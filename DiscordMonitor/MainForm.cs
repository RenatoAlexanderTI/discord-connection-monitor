...
namespace DiscordMonitor
{
    public partial class MainForm : Form
    {
        ...
        {
            base.OnLoad(e);
            // Ocultar de Alt+Tab sin cambiar el estilo visual
        ...
        private void BuildUI()
        {
            ...
            var sep1 = new Panel
            {
                ...
                Bounds = new Rectangle(12, 36, 216, 1),
            };

            _alertPanel = new Panel
            {
                Bounds = new Rectangle(12, 44, 216, 30),
                BackColor = Color.FromArgb(60, 222, 77, 77),
                Visible = false,
            };
            _lblAlertMsg = new Label
            {
                Text = "  Sin conexion durante llamada!",
                ForeColor = COL_RED,
                Font = new Font("Segoe UI", 8.5f, FontStyle.Bold),
                AutoSize = false,
                Bounds = new Rectangle(4, 6, 210, 18),
            };
            ...
            {
                BackColor = Color.FromArgb(40, 255, 255, 255),
                Bounds = new Rectangle(12, 126, 216, 1),
            };
        ...
        private void SetupTray()
        {
            ...
            {
                Text = "Discord Monitor",
                Icon = File.Exists("icon.ico") ? new Icon("icon.ico") : SystemIcons.Application,
                Visible = false,
            };
        ...
        public static bool IsAutostartEnabled()
        {
            try
            {
                ...
                return k?.GetValue(APP_NAME) != null;
            }
            catch
            {
                return false;
        ...
        private void FireAlerts()
        {
            ...
            Task.Run(() =>
            {
                try
                {
                    _tts?.SpeakAsync("Atencion. Se cayo la conexion. Estas en llamada de Discord.");
                }
                catch { }
            });
            try
        ...
        private void UpdateUI(bool discord, bool conn, int ping)
        {
            if (InvokeRequired)
            {
                Invoke(new Action(() => UpdateUI(discord, conn, ping)));
                return;
            }
        ...
        private void PositionOnSecondaryMonitor()
        {
            ...
            this.Location = new Point(
                target.WorkingArea.Right - this.Width - 16,
                target.WorkingArea.Top + 16
            );
        }
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            if (e.CloseReason == CloseReason.UserClosing)
            {
                ...
                _trayIcon.ShowBalloonTip(
                    2000,
                    "Discord Monitor",
                    "Sigue activo en la bandeja del sistema.",
                    ToolTipIcon.Info
                );
                return;
            }
